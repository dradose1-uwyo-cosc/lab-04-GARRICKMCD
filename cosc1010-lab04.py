...
for val in max_temps:
    sums = val + sums
    items = 1 + items
max_average = sums/items
print(f"The average maximum temperature was {max_average}")
totals = 0 
counts = 0
for val in min_temps:
    totals = val + totals
    counts = 1 + counts
min_average = totals/counts
print(f"The average minimum temperature was {min_average}")
